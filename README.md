...
| manulix3d/homebox        | 0.3.8         | v0.22.3     | A Helm chart for HomeBox, the inventory and organization system built for the Home Us |
| manulix3d/pocket-id      | 2.0.2         | v2.2.0      | pocket-id is a simple and easy-to-use OIDC provider that allows users to authenticate |
| manulix3d/vaultwarden    | 0.35.8        | 1.35.2      | vaultwarden is an unofficial Bitwarden-compatible server written in Rust              |
